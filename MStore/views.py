...
def validationCustomer(customer):
    ...
    elif (len(customer.phone_number) == 14 and customer.phone_number.startswith('+88') == True) or (len(customer.phone_number) == 11 and customer.phone_number.startswith('0') == True):
        pass
    else:
